...
export function CodeBracketIcon({ className = "w-16 h-16" }: { className?: string }) {
  return (
...
export function PixelRobotIcon({ className = "w-10 h-10" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      {/* Pixel art robot head */}
      <rect x="5" y="4" width="2" height="4" fill="currentColor" />
      <rect x="17" y="4" width="2" height="4" fill="currentColor" />
      <rect x="4" y="8" width="16" height="12" rx="2" fill="currentColor" opacity="0.8" />
      <rect x="7" y="11" width="3" height="3" fill="#00ffff" />
      <rect x="14" y="11" width="3" height="3" fill="#00ffff" />
      <rect x="8" y="16" width="8" height="2" fill="#111114" />
    </svg>
  );
}
